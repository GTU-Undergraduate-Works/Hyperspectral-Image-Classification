hsi_image_file_path = "HoustonDataset/HSI_DATA.tif"
lidar_image_file_path = "HoustonDataset/LiDAR_DATA.tif"
train_file_path = "HoustonDataset/train.txt"
test_file_path = "HoustonDataset/test.txt"
...
class Houston:
    ...
    def get_patches(self, data, pixels, patch_size):
        HEIGHT = data.shape[1]
        WIDTH = data.shape[2]
